...
function Contact() {
  return (
    <section className="rounded-2xl border border-stone-100 p-6 dark:border-stone-700/40">
      ...
      <Button
        href="mailto:emodie49@gmail.com,gwenmehta4@gmail.com,sandybeliso810@gmail.com,gwhaley@ahafremont.com"
        variant="primary"
